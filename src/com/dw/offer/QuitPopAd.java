...
public class QuitPopAd {
	...
	public void show(final Context context){
		...
		dialog = new Dialog(context, android.R.style.Theme_Translucent_NoTitleBar);//第二个样式参数可根据自己应用或游戏中的布局进行设置
	...
	private LinearLayout getQuitView_Landscape(final Context context, final Dialog dialog){
		...
		int height_tmp = height_full - 75;//75为设备状态栏加标题栏的高�?
